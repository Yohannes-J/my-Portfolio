...
const Navbar = () => {
  ...
  return (
    <nav className="flex flex-wrap justify-between md:items-center text-white px-10 pt-6 md:px-20">
      <img className="text-xl font-bold tracking-wide rounded-full w-36" src = {mylogo} alt=""/>
      ...
      {showMenu ? (
        <RiMenu2Line
          size={30}
          className="md:hidden absolute righyt-10 top-6 transition-all duration-300"
          onClick={() => {
            openMenu(!menu);
